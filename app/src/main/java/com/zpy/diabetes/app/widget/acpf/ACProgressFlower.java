package com.zpy.diabetes.app.widget.acpf;
    ...
    public void show() {
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                ...
                if (mBuilder.mDirection == AppConfig.DIRECT_CLOCKWISE) {
        ...
        mTimer.scheduleAtFixedRate(task, delay, delay);
    }
